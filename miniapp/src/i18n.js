...
export const I18N = {
  pt: {
    ...
    pendingDestinationCaption: 'O bot foi adicionado a estes grupos. Confirme quais devem receber postagens.',
    pendingAccept: 'Adicionar',
    pendingDismiss: 'Ignorar',
    pendingThreadHint: 'Thread ID (opcional — para grupos com tópicos)',
  ...
  en: {
    ...
    pendingDestinationCaption: 'The bot was added to these groups. Confirm which should receive posts.',
    pendingAccept: 'Add',
    pendingDismiss: 'Dismiss',
    pendingThreadHint: 'Thread ID (optional — for groups with topics)',
