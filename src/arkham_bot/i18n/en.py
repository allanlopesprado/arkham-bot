strings: dict = {
    ...
    "help_card_cmd": "  <code>/card</code> — guided search by cycle and pack",
    "help_sets_cmd": "  <code>/sets</code> — browse all cards organised by set",
    "help_search_cmd": "  <code>/search &lt;name&gt;</code> — free search by name or text",
    "help_rules_section": "📖 <b>Rules &amp; References</b>",
    "help_faq_cmd": "  <code>/faq &lt;code&gt;</code> — official Q&amp;A for a card",
    "help_taboo_cmd": "  <code>/taboo</code> — current taboo list with restrictions and errata",
    "help_decklist_cmd": "  <code>/decklist &lt;id&gt;</code> — view a public deck from ArkhamDB",
    "help_history_section": "📅 <b>History</b>",
    "help_cotd_cmd": "  <code>/cotd</code> — cards of the day posted by month",
    "help_bot_section": "⚙️ <b>Bot</b>",
    "help_status_cmd": "  <code>/status</code> — operational status and next scheduled post",
    ...
    "sets_btn_prev": "Previous",
    "sets_btn_next": "Next",
    "sets_no_sets": "No sets found.",
